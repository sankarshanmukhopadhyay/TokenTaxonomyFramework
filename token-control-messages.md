...
Transferable also has a `TransferFromRequest` and `TransferFromResponse` pair. See the sample [Transferable Control](artifacts/base/tokens.proto) messages for more detail.
